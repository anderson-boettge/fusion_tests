...
// int mat_h[] = {999999,36,515,317,96,
// 421,999999,718,392,331,
// 78,435,999999,807,604,
// 619,216,572,999999,883,
// 163,180,497,523,999999};
...
int calculaNPrefixosNivelDesejado(int nivelInicial,int nivelDesejado, int nVertice) {
...
int finalDFS(int N, short *preFixos, int idx, int *melhor_sol, int nPreFixos,int nivelPrefixo){
...
int dfs2(short *preFixos, int idx, const int nivelInicial, const int nivelDesejado, int *otimo_global) {
	...
	int qtd_prefixos_locais =  calculaNPrefixosNivelDesejado(nivelInicial,nivelDesejado,N);
